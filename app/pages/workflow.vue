    ...
    <UPageBody>
      <UContainer class="py-12">
        ...
        <div class="pt-6">
          ...
          <div v-if="currentStepIndex === 2 && !processingState" class="max-w-3xl mx-auto">
            <UCard class="mb-6 border-l-4 border-l-primary-500">
              <div class="flex items-start gap-4">
                <div class="p-2 bg-primary-50 dark:bg-primary-900/50 rounded-lg">
                  <UIcon name="i-lucide-library" class="w-6 h-6 text-primary-600" />
                </div>
                <div>
              ...
              >
                <div class="p-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                  <div class="flex items-center gap-3">
                    <UBadge color="primary" variant="solid" class="rounded-full w-6 h-6 flex items-center justify-center p-0">
                      {{ idx + 1 }}
                    </UBadge>
                    <div class="flex-1">
                  ...
                  >
                    <template #poems-list>
                      <div class="pl-4 pt-2 space-y-1">
                        <div v-for="(poem, pIdx) in chapter.poems" :key="pIdx" class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                          <UIcon name="i-lucide-feather" class="w-3 h-3 opacity-50" />
